    ...
    return (
        <section className={active?`aboutSection ${lowerCaseMode}ModeComponent`:`aboutSection ${lowerCaseMode}ModeComponent inactive`}>
            ...
            <section className='links'>
                <a href='https://github.com/SFCC5555' className={`${lowerCaseMode}ModeElement`}><span className={`skillIcon GitHubIcon${mode}`} target='_Blank' rel="noreferrer" ></span>GitHub</a>
                <a href={require('../assets/documents/RESUME2023FERNANDOCARRASCO.pdf')} className={`${lowerCaseMode}ModeElement`}><span className={`skillIcon cvIcon${mode}`} target='_Blank' rel="noreferrer" ></span>CV</a>
            </section>
